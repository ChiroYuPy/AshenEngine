...
namespace ash {
    ...
    public:
        static Ref<Camera2DController> Create(OrthographicCamera &camera, float moveSpeed = 300.0f,
    ...
    private:
        ...
        void HandleMouseScrolledEvent(const MouseScrolledEvent &mouseScrolled) const;
    };
}
